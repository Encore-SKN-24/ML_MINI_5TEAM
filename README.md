...
| 김지원 | • QGIS 통한 하천 거리 및 규모 등급 전처리<br>• 하천 데이터 CSV 전처리<br>• 머신러닝 (RandomForest) | https://github.com/edu-ai-jiwon |
| 박세현 | • 지역구 코드 전처리<br>• 지역구 면적 데이터 수집 | https://github.com/parksay |
| 임정희 | • 지역 코드 데이터 수집<br>• 침수 면적 데이터 크롤링<br>• 강수량 데이터 전처리<br>• 전처리 데이터 통합 및 가공<br>• 머신러닝 시각화 (XGBoost) | https://github.com/bigmooon |
...
- 국토교통부 V-WORLD : 국가기본도_하천중심선 / 시군구경계 / 토양 배수 등급
- 국토교통부 통계누리 : 지역구별 면적
- 공공데이터 포털 : 침수 흔적도 / 전국 배수 펌프장 / 기상관측소
- 재난 안전 데이터 공유 플랫폼 : 상습 침수 지역
- 기상청 API 허브 : 월별 강수량
- 국립농업과학원 흙토람 : 토양 배수 등급 분류 기준